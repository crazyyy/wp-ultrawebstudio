...
function optionsframework_init() {
	...
	if ( $optionsfile = locate_template( array('framework/options.php') ) ) {
		require_once($optionsfile);
	}
	else if (file_exists( dirname( __FILE__ ) . '/framework/options.php' ) ) {
		require_once dirname( __FILE__ ) . '/framework/options.php';
	}
...
function optionsframework_load_styles() {
	wp_enqueue_style('admin-style', OPTIONS_FRAMEWORK_DIRECTORY.'css/style-custom-admin.css');
				...
				<div id="optionsframework" class="postbox">
					<form action="options.php" method="post">
						...
						<div id="optionsframework-submit">
							<input type="submit" class="button button-primary button-large" name="update" value="<?php esc_attr_e( 'Save Options' ); ?>" />
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options' , 'swmtranslate'),
		'href' => admin_url( 'themes.php?page=options-framework' , 'swmtranslate')
  ));
}
